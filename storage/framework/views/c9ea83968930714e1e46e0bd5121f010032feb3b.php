<div class="widget-events widget-left-panel">
	<div class="menu-list">
		<ul class="list-unstyled">
			...
			<li><a href="<?php echo e(url(Auth::user()->username.'/pages')); ?>" class="btn menu-btn"><i class="fa fa-file-text" aria-hidden="true"></i><?php echo e(trans('common.pages')); ?> <span class="event-circle"><?php echo e(Auth::user()->own_pages()->count()); ?></span></a></li>
			...
			<li><a href="<?php echo e(url(Auth::user()->username.'/saved')); ?>" class="btn menu-btn"><i class="fa fa-save" aria-hidden="true"></i><?php echo e(trans('common.saved_items')); ?> </a></li>			
