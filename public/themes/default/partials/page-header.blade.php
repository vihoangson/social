<div class="timeline-cover-section">
	...
	<div class="timeline-list">
		<ul class="list-inline pagelike-links">	
			...
			<li class="{{ Request::segment(2) == 'add-pagemembers' ? 'active' : '' }}">
				<a href="{{ url($timeline->username.'/add-pagemembers')}}" ><span class="top-list"> {{ trans('common.addmembers') }}</span></a>
			</li>	
			@endif
		...
		<li class="{{ Request::segment(2) == 'page-posts' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/page-posts') }}"><span class="top-list">{{ count($timeline->posts()->where('active', 1)->get()) }} {{ trans('common.posts') }}</span></a></li>
