			...
			<div class="panel panel-default">
				...
				<div class="panel-body nopadding">
					<ul class="nav nav-pills heading-list">
						<li class="active"><a href="#posts" data-toggle="pill" class="header-text">{{ trans('common.posts') }}<span></span></a></li>
						<li class="divider">&nbsp;</li>
						<li class=""><a href="#pages" data-toggle="pill" class="header-text">{{ trans('common.pages') }}<span></span></a></li>
						<li class="divider">&nbsp;</li>
						<li class=""><a href="#groups" data-toggle="pill" class="header-text">{{ trans('common.groups') }}<span></span></a></li>
						<li class="divider">&nbsp;</li>
						<li class=""><a href="#events" data-toggle="pill" class="header-text">{{ trans('common.events') }}<span></span></a></li>
					</ul>
				</div>
